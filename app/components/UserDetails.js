...
UserDetails.propTypes = {
    ...
    // PropTypes.shape() allows you to have propTypes based on certain key values in your object
    info: PropTypes.shape({
        avatar_url: PropTypes.string.isRequired,
        // Ex. sometimes blog is not provided from github API
